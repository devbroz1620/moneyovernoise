...
const ETFLearn = () => {
  ...
  // ETF articles data - moved from the previous /learn/etfs structure
  const etfArticles = [
    {
      id: 'what-are-etfs',
      slug: 'what-are-etfs',
    ...
    {
      id: 'etf-taxation-india',
      slug: 'etf-taxation-india',
      title: 'ETF Taxation in India: What You Need to Know',
      description: 'Comprehensive guide to understanding how ETFs are taxed in India, including capital gains, dividend taxation, and tax-saving strategies.',
      readingTime: '15 min read',
      category: 'Advanced',
      tags: ['Taxation', 'India', 'Capital Gains', 'Tax Planning']
    },
    {
      id: 'index-fund-vs-etf',
      slug: 'index-fund-vs-etf',
      title: 'Index Funds vs ETFs: Making the Right Choice',
      description: 'Deep dive into the differences between index funds and ETFs, helping you choose the best option for your investment strategy.',
      readingTime: '11 min read',
      category: 'Intermediate',
      tags: ['Index Funds', 'ETFs', 'Comparison', 'Passive Investing']
    },
    {
      id: 'etf-mistakes-to-avoid',
      slug: 'etf-mistakes-to-avoid',
      title: '10 Common ETF Investing Mistakes to Avoid',
      description: 'Learn from the most common mistakes new ETF investors make and how to avoid them for better investment outcomes.',
      readingTime: '9 min read',
      category: 'Beginner',
      tags: ['Mistakes', 'Tips', 'Beginner Guide', 'Investment Strategy']
    }
  ];
