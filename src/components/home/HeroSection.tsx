      ...
      <div className="container px-4 md:px-6">
        <div className="grid gap-6 lg:grid-cols-2 lg:gap-12 items-center">
          ...
          <div className="mx-auto lg:mx-0 bg-muted rounded-lg p-8 shadow-lg">
            <div className="rounded-lg bg-gradient-to-br from-blue-50 to-indigo-100 border border-blue-100 p-8 h-full flex flex-col justify-center">
              <div className="grid gap-6">
                ...
                <div className="flex items-center gap-4">
                  ...
                  <div className="space-y-1">
                    <h3 className="font-semibold">India Focused</h3>
                    <p className="text-sm text-muted-foreground">
