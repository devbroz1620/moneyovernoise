...
import { etfLearnArticles } from '@/data/etfLearnData';
...
const ETFLearnArticle = () => {
  ...
  const article = etfLearnArticles[slug];
          ...
          <footer className={`mt-12 pt-8 border-t ${isMobile ? 'mt-8 pt-6' : 'mt-12 pt-8'}`}>
            <div className="flex flex-col sm:flex-row items-center justify-between gap-4">
              ...
              <div className="flex items-center gap-3">
                ...
                <ShareButton 
                  title={article.title}
                  url={`${window.location.origin}/etfs/learn/${article.slug}`}
                  isMobile={isMobile}
                />
              </div>
            </div>
